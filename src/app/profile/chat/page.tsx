...
function TypingIndicator() {
  return (
    <div className="flex items-end gap-2 mb-3">
      <img src="/icon.png" alt="Avent Ridge Exchange Support" className="h-8 w-8 rounded-full object-contain shadow flex-shrink-0" />
    ...
    <div className="h-dvh flex flex-col bg-background text-foreground overflow-hidden">
      ...
      <header className="sticky top-0 z-30 backdrop-blur-xl border-b bg-background/95 border-border px-4 py-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <img src="/icon.png" alt="Avent Ridge Exchange Support" className="h-10 w-10 rounded-full object-contain shadow flex-shrink-0" />
          <div>
            <p className="font-bold text-sm leading-none">Avent Ridge Exchange Support</p>
        ...
        {(messages as any[]).length === 0 && !loadingMsgs && (
          ...
          >
            ...
            <div className="bg-muted rounded-2xl rounded-tl-sm px-4 py-3 max-w-[75%]">
              <p className="text-[10px] font-black text-primary uppercase tracking-wider mb-1">Support</p>
              <p className="text-sm">
                👋 Hi {userName}! Welcome to Avent Ridge Exchange support. How can we help you today?
              </p>
            </div>
          </motion.div>
        )}
